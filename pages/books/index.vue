      ...
      >
        ...
        <div class="col-lg-5 books-details__description">
          <h5 class="h5 books-details__description__text">
            <i class="fa fa-quote-left books-details__description__text__quote--left" aria-hidden="true"></i>
            {{ book.description }}
            <i class="fa fa-quote-right books-details__description__text__quote--right" aria-hidden="true"></i>
          </h5>
        </div>
